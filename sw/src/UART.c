...
// Clear display
void UART_Output_Clear(void){ // Clears the display
  // not implemented on the UART
}
// Turn off display (low power)
void UART_Output_Off(void){   // Turns off the display
  // not implemented on the UART
}
// Turn on display
void UART_Output_On(void){    // Turns on the display
  // not implemented on the UART
}
// set the color for future output
void UART_Output_Color(uint32_t newColor){ // Set color of future output 
  // not implemented on the UART
}
